  ...
  modules: VulnerabilityModule[] = [
    {
      ...
      shortTitle: 'Overview',
  description: 'Introducción al OWASP Top 10 y su aplicación en aplicaciones full-stack (Angular + .NET)',
      icon: '🎯',
      severity: 'medium',
      completed: false,
      chapters: [
    ...
    },
    {
      ...
      shortTitle: 'XSS',
  description: 'Inyección XSS - Cross-Site Scripting en aplicaciones full-stack (Angular + .NET)',
      icon: '💉',
      severity: 'critical',
      completed: false,
      chapters: [
